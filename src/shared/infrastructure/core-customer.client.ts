...
import type { CustomerEnrollmentCoreRecordDto } from '../../modules/enrollment/domain/ports/enrollment.repository';
import type { CustomerPasswordChangeCoreRecordDto } from '../../modules/auth/domain/ports/auth.repository';
import type { CustomerLoginCoreRecordDto } from '../../modules/auth/domain/ports/auth.repository';
import type { CustomerProfileSummaryCoreResponseDto } from '../../modules/profile/domain/ports/profile.repository';
